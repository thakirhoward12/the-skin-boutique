...
export const HeimishProducts: Product[] = [
  {
    ...
    "category": "Eye Patch",
    "price": 661.28,
    "image": "https://cdn.shopify.com/s/files/1/0515/4589/9157/files/HEIMISH_Bulgarian_Rose_Water_Hydrogel_Eye_Patch__30_Pairs_-removebg-preview.png?v=1766244317",
    "description": "Kiyoko's Notes A moisturizing rose-scented eye patch to nourish and revitalize tired under eyes. Heimish Bulgarian Rose Water Hydrogel Eye Patch is a hypoallergenic gel patch enriched in Bulgarian Rose Water to hydrate, brighten and reduce signs of aging! It is the perfect way to finish off your skincare routine for those who have stressed and tired eyes or other targeted areas (forehead, smile lines, chin, etc.) The hydrogel eco-friendly patches can also easily dissolve in hot water to be used as an essence on the face! Features Improves fine lines and wrinkles Brightens dull areas and dark circles Enhances skin elasticity and moisture barrier Skin Concerns Dehydrated skin Fine lines and wrinkles Dullness Skin Types All skin types Suitable for sensitive skin Made In South Korea How to use After cleansing, place the eye patch on the desired facial area using the enclosed spatula. Remove after 20-30 mins.",
    "ingredients": "Water, Glycerin, Niacinamide, Chondrus Crispus (Carrageenan), Butylene Glycol, Cocos Nucifera (Coconut) Fruit Extract , Pinus Sylvestris Leaf Extract, Propanediol, Pentylene Glycol, Rosa Damascena Flower Water(1000ppm), Nelumbo Nucifera Flower Extract, Portulaca Oleracea Extract, Hamamelis Virginiana (Witch Hazel) Extract , Centella Asiatica Extract, Ethylhexylglycerin, Sodium Hyaluronate, Dipotassium Glycyrrhizate, PEG-60 Hydrogenated Castor Oil, Ceratonia Siliqua Gum, Sucrose, Potassium Chloride, Cyamopsis Tetragonoloba (Guar) Gum, Calcium Chloride, Allantoin, Tripropylene Glycol, Dipropylene Glycol, Cellulose Gum, Chondrus Crispus Powder, Ricinus Communis (Castor) Seed Oil, Calcium Aluminum Borosilicate, Tin Oxide, Carmine, Calcium Lactate, Adenosine, Synthetic Fluorphlogopite, Titanium Dioxide, Disodium EDTA, Ethyl Hexanediol, 1,2-Hexanediol, Chlorphenesin, Arginine, Fragrance",
    "options": [],
    "reviews": [
      {
    ...
    "supplierId": "teemdrop",
    "sourceUrl": "https://kiyoko.com/products/heimish-bulgarian-rose-water-hydrogel-eye-patch-30-pairs-60-pcs",
    "sourcePrice": 16,
  ...
  },
  {
    ...
    "supplierId": "teemdrop",
    "sourceUrl": "https://kiyoko.com/products/heimish-marine-care-eye-cream-30ml",
    "sourcePrice": 24,
