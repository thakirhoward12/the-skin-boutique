...
export const TocoboProducts: Product[] = [
  {
    ...
    "description": "Kiyoko's Notes Tocobo Sun Stick with cotton extract for a soft, non-sticky finish. TOCOBO Cotton Soft Sun Stick protects and nourishes your skin. This portable sun stick provides SPF 50+ PA++++ UV protection and is made with natural ingredients like evening primrose flower extract and jojoba seed oil.",
    ...
    "supplierId": "teemdrop",
    "sourceUrl": "https://kiyoko.com/products/tocobo-cotton-soft-sun-stick-spf50-pa-19g",
    "sourcePrice": 23,
