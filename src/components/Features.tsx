        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-10">
          {features.map((feature, index) => (
            <motion.div 
              ...
              className="group relative premium-glass rounded-[2rem] p-8 text-center transition-all duration-500"
            >
              <div className="relative z-10">
                <div className="mx-auto flex items-center justify-center h-16 w-16 rounded-2xl bg-white shadow-sm border border-ink-50 text-ink-900 mb-7 group-hover:scale-110 group-hover:shadow-md transition-all duration-500">
                  <feature.icon className="h-6 w-6 stroke-[1.2]" aria-hidden="true" />
                </div>
