...
try:
    js_content = ts_content.split('export const products: Product[] = ')[1]
    js_code = "const products = " + js_content
    ...
    <head>
        ...
        <title>Skincare Boutique Preview</title>
        <style>
            body { font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #fdf5f6; margin: 0; padding: 40px 20px; }
            h1 { text-align: center; color: #4a4a4a; font-weight: 300; font-size: 2.5rem; margin-bottom: 40px; letter-spacing: 1px; }
            .grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 30px; max-width: 1200px; margin: 0 auto; }
            .card { background: white; border-radius: 20px; overflow: hidden; box-shadow: 0 10px 20px rgba(0,0,0,0.03); transition: transform 0.3s ease, box-shadow 0.3s ease; }
            ...
            .name { font-size: 18px; color: #212121; margin: 0 0 12px 0; font-weight: 500; line-height: 1.4; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; height: 50px; }
    ...
    <body>
        ...
        <script>
            ...
            document.getElementById('summary').innerText = `Displaying ${products.length} beautiful products!`;
        </script>
    </body>
    </html>
    """
